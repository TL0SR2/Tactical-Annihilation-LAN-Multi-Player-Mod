...
设计基线（已 ACCEPTED，人工可副署或 SUPERSEDED）：

| 编号 | 文件 | 状态 |
|:---|:---|:---|
| ADR-001 | [ADR-001-host-authority.md](./ADR-001-host-authority.md) | ACCEPTED |
...
| ADR-003 附录 | [ADR-003-appendix-random-tape.md](./ADR-003-appendix-random-tape.md) | DRAFT / DEFERRED（P-Learn PL6） |
